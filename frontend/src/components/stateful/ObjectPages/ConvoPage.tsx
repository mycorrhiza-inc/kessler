...
export default async function ConvoPage({ convo_id, urlParams }: { convo_id: string, urlParams: TypedUrlParams }) {
  try {
    ...
    return <ErrorMessage error={err} message="Could not get conversation data from server :(" />
  }
}
