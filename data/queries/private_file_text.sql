...
INSERT INTO public.private_file_text_source (
		file_id,
		is_original_text,
		language,
		text,
...
SELECT text
FROM public.private_file_text_source
WHERE file_id = $1;
...
UPDATE public.private_file_text_source
SET text = $1,
	updated_at = NOW()
WHERE id = $2
RETURNING id;
...
DELETE FROM public.private_file_text_source
WHERE file_id = $1;
