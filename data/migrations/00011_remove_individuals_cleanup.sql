...
-- +goose Down
ALTER TABLE
    public.organization DROP COLUMN is_person;

ALTER TABLE
    public.relation_documents_organizations_authorship DROP COLUMN is_primary_author;

ALTER TABLE
    IF EXISTS public.relation_documents_organizations_authorship RENAME TO public.relation_documents_organizations;
