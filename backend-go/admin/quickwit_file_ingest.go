...
func HandleQuickwitFileIngestFromPostgres(w http.ResponseWriter, r *http.Request) {
	...
	err := QuickwitIngestFileFromPostgres(q, ctx, filter_out_unverified)
	if err != nil {
...
func QuickwitIngestFileFromPostgres(q *dbstore.Queries, ctx context.Context, filter_out_unverified bool) error {
