...
SELECT
    organization_alias, organization_id, id, created_at, updated_at
FROM
    public.organization_aliases
WHERE
    organization_id = $1
...
func (q *Queries) OrganizationGetAllAliases(ctx context.Context, organizationID uuid.UUID) ([]OrganizationAlias, error) {
